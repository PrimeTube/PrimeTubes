...
public class MainActivity extends AppCompatActivity {
	...
	private ObjectAnimator objectanimation = new ObjectAnimator();
	...
	public void _object_animation() {
		objectanimation.setTarget(imageview1);
		objectanimation.setPropertyName("alpha");
		objectanimation.setFloatValues((float)(0), (float)(1));
		objectanimation.setDuration((int)(2000));
